...
def createScene(rootNode):
    ...
    controlPointMO = controlPointNode.addObject('MechanicalObject', template='Rigid3d', name="controlPointMO",
                                                position="0 0 0  0 0 0. 1", showObject='1', showObjectScale='0.2')
    ...
    mappedFrameNode.addObject('RestShapeSpringsForceField', name='controlSpring', stiffness="1.e6",
                              angularStiffness="1.e6", external_rest_shape="@../../../controlPointNode/controlPointMO",
                              external_points="0", mstate="@FramesMO", points=nbFrames-1, template="Rigid3d")
