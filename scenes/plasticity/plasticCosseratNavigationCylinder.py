...
def createScene(rootNode):
    ...
    rootNode.addObject('LocalMinDistance', name="Proximity", alarmDistance=1.3*sectionRadius, contactDistance=sectionRadius)
    ...
    dataDisplayNode = anatomyNode.addChild('dataDisplayNode')
    dataDisplayNode.addObject('DataDisplay', name='DataDisplay')
    dataDisplayNode.addObject('OglColorMap', colorScheme="Blue to Red")
    dataDisplayNode.addObject('IdentityMapping', input="@../anatomyDoFs", output="@.")
    rootNode.addObject(ColorMapController(rootNode=rootNode, springStiffness=forceEstimationSpringStiffness,
