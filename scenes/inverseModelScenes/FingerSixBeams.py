...
def createScene(rootNode):
    ...
    sectionFrames = [[0.0, 0, 0,  0, 0, 0, 1],   [15.0, 0, 0,  0, 0, 0, 1],   [30.0, 0, 0,  0, 0, 0, 1],
                     [45.0, 0, 0,  0, 0, 0, 1],
                     [60.0, 0, 0,  0, 0, 0, 1], [66.0, 0, 0,  0, 0, 0, 1],   [81.0, 0, 0,  0, 0, 0, 1]]
    ...
    mappedFrameNode.createObject('DiscretCosseratMapping', curv_abs_input=curv_abs_input,
                                 ...
                                 index="1 1 1 2 2 3 3 3 4 4 5 6 6 6")
    ...
    rootNode.createObject('BilateralInteractionConstraint', template='Rigid3d',
                          ...
                          object2="@mappedSection1/sectionF", first_point="0 3 5 8 10 11 14",
                          second_point="0 1 2 3 4 5 6")
