...
def createScene(rootNode):
    ...
    cable.createObject('CableActuator', name="aCableActuator",
                       indices=range(0, 16),
    ...
    # effector.createObject('SkinningMapping', nbRef='1')
    effector.createObject('RigidMapping')

    mappedFrameNode.createObject('LinearSolverConstraintCorrection')
