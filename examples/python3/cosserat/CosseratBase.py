...
class CosseratBase(Sofa.Prefab):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.params = kwargs.get('params', Parameters())  # Use the Parameters class with default values
    ...
    def _addRigidBaseNode(self):
        ...
        positions = [[self.params.beamGeoParams.init_pos] + [0., 0., 0., 1.]]
...
def createScene(rootNode):
    ...
    cosserat = solverNode.addChild(
        CosseratBase(parent=solverNode, params=Params))
