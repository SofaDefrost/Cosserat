...
def createScene(rootNode):
    ...
    internState.addObject("BeamHookeLawForceFieldRigid", template="Vec6", length = seg_length, crossSectionShape = 'rectangular', lengthY = e, lengthZ = w, youngModulus = E, poissonRatio = nu )



    # Frames along the rod
    # Frames are child of state and rigid base
