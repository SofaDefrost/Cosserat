...
void CosseratActuatorConstraint<DataTypes>::init()
{
    ...
    if(!d_minForce.isSet())
        msg_warning() << "An old implementation of CosseratActuatorConstraint was not allowing negative force. This is now possible. "
...
template<class DataTypes>
void CosseratActuatorConstraint<DataTypes>::setUpDisplacementLimits(double& imposedValue, double& minForce, double& maxForce)
{
