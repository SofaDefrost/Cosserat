...
//
#define SOFA_COSSERATPLUGIN_CPP_LegendrePolynomialsMapping
...
namespace sofa::component::mapping
{
    ...
    template class SOFA_COSSERATPLUGIN_API LegendrePolynomialsMapping< sofa::defaulttype::Vec3Types, sofa::defaulttype::Vec3Types >;
} // namespace sofa::component::mapping
