...
/*!
 * \class LimitedDifferenceMapping
...
class LimitedDifferenceMapping : public core::Multi2Mapping<TIn1, TIn2, TOut>
{
public:
    SOFA_CLASS(SOFA_TEMPLATE3(LimitedDifferenceMapping, TIn1,TIn2, TOut), SOFA_TEMPLATE3(core::Multi2Mapping, TIn1, TIn2, TOut) );
...
protected:
    Data< type::vector<unsigned int> > d_mappedIndices1;
    Data< type::vector<unsigned int> > d_mappedIndices2;
    Data< type::vector<unsigned int> > d_mappedEntries;
    Data< bool >                         d_debug;
...
protected:
    /// Constructor    
    LimitedDifferenceMapping() ;
    /// Destructor
    ~LimitedDifferenceMapping()  override = default;
    unsigned int m_nbMappedIndices;
public:
