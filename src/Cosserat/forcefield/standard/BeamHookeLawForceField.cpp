...
namespace sofa::component::forcefield {
	...
	// { 		SOFA_UNUSED(d_v); 		SOFA_UNUSED(mparams);
	//
	// 		if (!this->getMState()) {
	...
	//
	// 	template <>
	// void BeamHookeLawForceField<defaulttype::Vec6Types>::addDForce(const MechanicalParams *mparams, DataVecDeriv
	// &d_df, 																   const DataVecDeriv &d_dx) { 		if (!compute_df) 			return;
	//
