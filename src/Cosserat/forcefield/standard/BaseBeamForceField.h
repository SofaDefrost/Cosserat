...
#if !defined(SOFA_COSSERAT_CPP_BaseBeamForceField)
	extern template class SOFA_COSSERAT_API BaseBeamForceField<defaulttype::Vec3Types>;
// extern template class SOFA_COSSERAT_API BaseBeamForceField<defaulttype::Vec6Types>;
#endif
