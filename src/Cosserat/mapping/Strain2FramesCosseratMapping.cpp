 ...
 ******************************************************************************/
#define SOFA_COSSERAT_CPP_Strain2FramesCosseratMapping
#include <Cosserat/mapping/Strain2FramesCosseratMapping.inl>
#include <sofa/core/ObjectFactory.h>
#include <sofa/defaulttype/VecTypes.h>

namespace Cosserat::mapping {
	template class SOFA_COSSERAT_API Strain2FramesCosseratMapping<
...
namespace Cosserat {
	...
	void registerStrain2FramesCosseratMapping(sofa::core::ObjectFactory *factory) {
		factory->registerObjects(
				sofa::core::ObjectRegistrationData(
						"This component facilitates the creation of Strain2Frames Mapping in SOFA simulations. "
						...
						.add<mapping::Strain2FramesCosseratMapping<sofa::defaulttype::Vec3Types,
															   sofa::defaulttype::Rigid3Types,
															   sofa::defaulttype::Rigid3Types>>(true)
						.add<mapping::Strain2FramesCosseratMapping<sofa::defaulttype::Vec6Types,
															   sofa::defaulttype::Rigid3Types,
															   sofa::defaulttype::Rigid3Types>>());
	}
} // namespace Cosserat
