...
namespace Cosserat::mapping {
	...
	public:
		...
		/**********************MAPPING METHODS**************************/
		void apply(const sofa::core::MechanicalParams * /* mparams */, const vector<OutDataVecCoord *> &dataVecOutPos,
				   const vector<const In1DataVecCoord *> &dataVecIn1Pos,
				   const vector<const In2DataVecCoord *> &dataVecIn2Pos) override;

		void applyJ(const sofa::core::MechanicalParams * /* mparams */, const vector<OutDataVecDeriv *> &dataVecOutVel,
		...
		void applyJT(const sofa::core::ConstraintParams *cparams, const vector<In1DataMatrixDeriv *> &dataMatOut1Const,
		...
		/// Common implementation called by computeProximity and computeNeedleProximity.
		/// If fixLastPoint==true, the last FEM point is treated as a fixed bilateral
		/// 3D constraint tied to the last cable node.
		void computeProximityImpl(const In1VecCoord &x1, const In2VecCoord &x2, bool fixLastPoint);
