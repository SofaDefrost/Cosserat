...
namespace sofa::core::behavior {
	...
	void PointsManager::addNewPointToState() {
		...
		helper::WriteAccessor<Data<VecCoord>> xRest =
				*this->getMstate()->write(core::vec_id::write_access::restPosition);
		helper::WriteAccessor<Data<VecCoord>> xfree =
				*this->getMstate()->write(core::vec_id::write_access::freePosition);
