 ...
 */
template<typename _Scalar>
Eigen::Matrix<_Scalar, 6, 1> operator/(const Eigen::Matrix<_Scalar, 6, 1>& point_vel,
...
/**
 * @brief Create SE_2(3) transformation from position, Euler angles, and velocity
 */
template<typename _Scalar>
SE23<_Scalar> fromPositionEulerVelocity(const typename SE23<_Scalar>::Vector3& position,
                                       const _Scalar& roll,
                                       const _Scalar& pitch,
                                       const _Scalar& yaw,
                                       const typename SE23<_Scalar>::Vector3& velocity) {
 ...
 */
template<typename _Scalar>
SE23<_Scalar> interpolate(const SE23<_Scalar>& from,
                         const SE23<_Scalar>& to,
                         const _Scalar& t) {
