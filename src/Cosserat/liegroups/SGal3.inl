...
/**
 * @brief Create SGal(3) transformation from position, Euler angles, velocity, and time
 */
template<typename _Scalar>
SGal3<_Scalar> fromPositionEulerVelocityTime(
    const typename SGal3<_Scalar>::Vector3& position,
    const _Scalar& roll,
    const _Scalar& pitch,
    const _Scalar& yaw,
    const typename SGal3<_Scalar>::Vector3& velocity,
 ...
 */
template<typename _Scalar>
SGal3<_Scalar> interpolate(const SGal3<_Scalar>& from,
                          const SGal3<_Scalar>& to,
                          const _Scalar& t) {
