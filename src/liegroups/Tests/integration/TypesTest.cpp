...
namespace sofa::component::cosserat::liegroups::testing {
	 ...
	 * Verifies that a 3D vector can be converted to a skew-symmetric matrix and back, and that the matrix is indeed
	 * skew-symmetric.
	 */
	...
	TEST_F(TypesTest, RandomFunctions) {
		std::mt19937 gen(0);
		double random_scalar = Typesd::randomScalar(gen);
