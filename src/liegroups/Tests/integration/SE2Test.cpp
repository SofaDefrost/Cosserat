...
namespace sofa::component::cosserat::liegroups::testing {
	 ...
	 * Verifies that SE2 objects can be constructed from default, rotation and translation, and angle and translation
	 * representations.
	 */
	...
	TYPED_TEST(SE2Test, HatVee) {
		...
		Matrix hat_twist = SE2::computeHat(twist);
		TangentVector vee_hat_twist = SE2::computeVee(hat_twist);
	...
	TYPED_TEST(SE2Test, Adjoint) {
		...
		AdjointMatrix ad_twist = SE2::computeAd(twist);
