...
try:
    ...
    try:
        ...
        mapping3_class = getattr(Cosserat, 'Strain2FramesCosseratMapping3', None)
        mapping6_class = getattr(Cosserat, 'Strain2FramesCosseratMapping6', None)
        
        if mapping3_class:
            print("✓ Strain2FramesCosseratMapping3 class is available")
        else:
            print("✗ Strain2FramesCosseratMapping3 class not found")
            
        if mapping6_class:
            print("✓ Strain2FramesCosseratMapping6 class is available")
        else:
            print("✗ Strain2FramesCosseratMapping6 class not found")
