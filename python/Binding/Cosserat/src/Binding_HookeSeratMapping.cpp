...
void moduleAddHookeSeratMapping(py::module &m) {
    ...
    // py::class_<HookeSeratDiscretMapping6, CosseratGeometryMapping<Vec6Types, Rigid3Types, Rigid3Types>, py_shared_ptr<HookeSeratDiscretMapping6>> c6(m, "HookeSeratDiscretMapping6");
