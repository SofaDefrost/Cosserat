...
def _add_cosserat_state_v2(p_node, geometry: CosseratGeometry, node_name="cosserat_coordinates", custom_bending_states=None):
    """Create the cosserat coordinate node using CosseratGeometry."""
    cosserat_coordinate_node = p_node.addChild(node_name)
...
def createScene(root_node):
    ...
    # bending_node = _add_cosserat_state(root_node, beam_geometry, node_name="c_state_1",
    ...
    bending_node_2 = _add_cosserat_state_v2(root_node, beam_geometry, node_name="c_state_2", custom_bending_states=custom_bending_states)

    # Create cosserat frame using the geometry object
    # Add mapping node with old method
    _add_cosserat_frame_v2(base_node_2, bending_node_2, beam_geometry, node_name="frame_2", beam_mass=1.0)
