...
from introduction_and_setup import (
    _add_cosserat_frame,
    _add_cosserat_state,
    _add_cosserat_state_v2,
    _add_rigid_base,
    add_mini_header,
)
...
v_damping_param: float = 8.0e-1  # Damping parameter for dynamics
...
def createScene(root_node):
    ...
    ##################################################
    ######### Validate with new improvementation #####
    ##################################################

    solver_node_2 = root_node.addChild("solver_2")
    solver_node_2.addObject(
        "EulerImplicitSolver",
        firstOrder="0",
        rayleighStiffness="0.0",
        rayleighMass="0.0",
    ...
    solver_node_2.addObject("SparseLDLSolver", name="solver_2")
    # Create rigid base
    base_node_2 = _add_rigid_base(solver_node_2, node_name="rigid_base_2")

    # Create cosserat state using geometry
    bending_node_2 = _add_cosserat_state_v2(
        solver_node_2,
        beam_geometry,
