...
from introduction_and_setup import _add_cosserat_frame_v2, _add_cosserat_state, _add_rigid_base, add_mini_header
...
def createScene(root_node):
    ...
    custom_bending_states = [
        [0.0, 0.0, 0.0],  # Section 1: slight bend in y and z
        [0.0, 0.0, 0.0],  # Section 2: slight bend in y and z
        [0.0, 0.0, 0.2]   # Section 3: slight bend in y and z
    ]
    ...
    _add_cosserat_frame_v2(base_node1, bending_node, beam_geometry1, node_name="cosserat_in_Sofa_frame_node2",
                        beam_mass=0.0)
    ...
    _add_cosserat_frame_v2(base_node2, bending_node2, beam_geometry2, node_name="cosserat_in_Sofa_frame_node2" , beam_mass=0.0)
