...
def createScene(rootNode):
    ...
    solverNode.addObject('CGLinearSolver', name="solver",
                         iterations='2000', tolerance='1e-12', threshold='1e-18')
    ...
    constraintSpringStiffness = 1.0e12
    constraintSpringAngularStiffness = 1.0e5
    constraintWith0Node.addObject('RestShapeSpringsForceField', name='constraintMappingSpring',
                                  ...
                                  angularStiffness=constraintSpringAngularStiffness,
                                  # external_rest_shape="@",
                                  # external_points="",
                                  points="",
