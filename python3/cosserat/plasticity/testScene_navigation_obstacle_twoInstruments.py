...
def createScene(rootNode):
    ...
    rigidBaseNode0.addObject('RestShapeSpringsForceField', name='controlSpring',
                             stiffness="1.0e8", angularStiffness="1.0e5",
    ...
    youngModulus = 1.5e9 # in kg.cm-1.s-2 (1 Pa = 1 kg.m-1.s-2 = 0.01 kg.cm-1.s-2)
    ...
    rigidBaseNode1.addObject('RestShapeSpringsForceField', name='controlSpring',
                             stiffness="1.0e2", angularStiffness="1.0e2",
    ...
    instrument1ConstantRestStrain1 = [0., 0., 0.]
    ...
    youngModulus = 1.15e5 # 150 GPa = 1.5e11 Pa = 1.5e9 kg.cm-1.s-2 (1 Pa = 1 kg.m-1.s-2 = 0.01 kg.cm-1.s-2)
