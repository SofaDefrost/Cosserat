...
# if( and ( or (prop("Status") == "Not started", or (prop("Status") == "Upcoming", contains(prop("Status"), "Overdue"))), and (now() > prop("Deadline"), prop("Done") == false)), "🚨 Overdue 🚨", if( or(prop("Status") == "Archived", contains(prop("Status"), "Done")), "🏅VALIDÉ", "DOING"))
