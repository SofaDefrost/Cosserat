...
The test cases are defined in the #Test_Cases member group.
  */
template <typename _DiscretCosseratMapping>
struct DiscretCosseratMappingTest : public Multi2Mapping_test<_DiscretCosseratMapping>
{

    typedef _DiscretCosseratMapping DiscretCosseratMapping;
    typedef Multi2Mapping_test<DiscretCosseratMapping> Inherit;

    typedef typename DiscretCosseratMapping::In1 In1Type;
    ...
    typedef typename DiscretCosseratMapping::In1DataVecCoord In1DataVecCoord;
    typedef typename DiscretCosseratMapping::In1DataVecDeriv In1DataVecDeriv;
    ...
    typedef typename DiscretCosseratMapping::In2 In2Type;
    ...
    typedef typename DiscretCosseratMapping::In2DataVecCoord In2DataVecCoord;
    typedef typename DiscretCosseratMapping::In2DataVecDeriv In2DataVecDeriv;
    ...
    typedef typename DiscretCosseratMapping::Out OutType;
    ...
    typedef typename DiscretCosseratMapping::OutDataVecCoord OutDataVecCoord;
    typedef typename DiscretCosseratMapping::OutDataVecDeriv OutDataVecDeriv;
    ...
    DiscretCosseratMapping* poeMapping; ///< the mapping to be tested
    ...
    /// Constructor
    DiscretCosseratMappingTest()
        :filepath("/home/younes/travail/plugin/plugin.Cosserat/tests/mapping/POEMapping_test1.pyscn")
    {
    ...
    */
    ...
    bool runTest1()
    {
        ...
        //        DiscretCosseratMapping* poeMapping;
        ...
        //        //(const vector<In1VecCoord>& in1Coords, const vector<In2VecCoord>& in2Coords, const OutVecCoord& expectedChildCoords);
...
using testing::Types;
typedef Types<
mapping::DiscretCosseratMapping< sofa::defaulttype::Vec3Types, sofa::defaulttype::Rigid3Types, sofa::defaulttype::Rigid3Types >> DataTypes; // the types to instanciate.


// Test suite for all the instanciations
TYPED_TEST_CASE(DiscretCosseratMappingTest, DataTypes);
// first test case
TYPED_TEST( DiscretCosseratMappingTest , runTest1 )
{
