...
scenespath = os.path.dirname(os.path.abspath(__file__))+'/../tutorials/'

sofabin=""
if len(sys.argv) > 1: sofabin  = sys.argv[1]
if not os.path.isfile(sofabin): sofabin = os.path.dirname(os.path.abspath(__file__))+'/../../../build-release/master/bin/runSofa'
if not os.path.isfile(sofabin): sofabin = os.path.dirname(os.path.abspath(__file__))+'/../../../build/master/bin/runSofa'
if not os.path.isfile(sofabin): sofabin = os.path.dirname(os.path.abspath(__file__))+'/../../../../build-release/master/bin/runSofa'
if not os.path.isfile(sofabin): sofabin = os.path.dirname(os.path.abspath(__file__))+'/../../../../build/master/bin/runSofa'

if os.path.isfile(sofabin): 

    supportedExtensions = [".pyscn",".scn", ".py"]
    pattern = "/"
    ...
    def dotest(arg, dirname, names):
        ...
        outputFilename = os.path.dirname(os.path.abspath(__file__))+"/TestTutorialsScenesOutput.txt"
